...
<head>
    ...
    <!-- link css file -->
    <link rel="stylesheet" href="/newInstitute/abmin_css_file/veiw_stu.css">
        ...
        <div class="table-box">
            <table cellpadding ="10" id = "veiw_tb">
                ...
                <div class ="tb">
                    ...
                    ?>
                            <td><?php echo $row['s_user_name'] ?></td>
                            ...
                            <td>
                                <a href="/newInstitute/abmin_html_file/update_student.php?s_user_name=<?php echo $row['s_user_name'] ?>"><i class="fa-solid fa-pen-to-square edit"></i></a>
                                <a href="/newInstitute/abmin_html_file/add_student_class.php?s_user_name=<?php echo $row['s_user_name'] ?>"><i class="fa-sharp fa-solid fa-plus"></i></a>
                                <a onclick= "checker()" href="/newInstitute/admin_php_file/delete.php?s_user_name=<?php echo $row['s_user_name'] ?>"><i class="fa-solid fa-trash delete"></i></a>
                            </td>
